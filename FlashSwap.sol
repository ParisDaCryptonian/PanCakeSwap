...
contract PancakeFlashSwap {
    ...
    function placeTrade(
        ...
        require(amountReceived > 0, "Aborted Tx: Trade returned to zero");

        return amountReceived;
    }

    // CHECK PROFITABILITY
    // Checks whether output is greater than input
    ...
    function startArbitrage(address _tokenBorrow, uint256 _amount) external {
        ...
        IERC20(ALPACA).safeApprove(address(PANCAKE_ROUTER), MAX_INT);
        ...
        // Execute the initial way to get the loan
    ...
    function pancakeCall(
        ...
        // Place Trades
        uint256 trade1AcquiredCoin = placeTrade(BUSD, ALPACA, loanAmount);
        uint256 trade2AcquiredCoin = placeTrade(ALPACA, CAKE, trade1AcquiredCoin);
